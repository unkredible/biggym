...
export default async function LoginPage({
  ...
  if (searchParams.check === "email") {
    return (
      <main>
        ...
        <p className="card">
          We sent you a sign-in link. Open it on this device to continue. You can
          close this tab.
        </p>
      </main>
    );
  ...
  return (
    <main>
      ...
      {/* ---- Sign up ---- */}
      <div className="section">
        <div className="section-label">New gym? Sign up</div>
        <form
          className="card"
          action={async (formData) => {
            "use server";
        ...
        >
          <p className="muted" style={{ marginTop: 0 }}>
            We&apos;ll email you a link to confirm your address, then you set a
